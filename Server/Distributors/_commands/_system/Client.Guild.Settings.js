  ...
  module.exports = {
    ...
    onRequest: async function (client, message, args) {
      ...
      const buttonSatir = new MessageActionRow().addComponents(
        ...
        .addOptions(
          { label: "Botları Yeniden Başlat", description: "Tüm botları yeniden başlatır.", value: "restleaq", emoji: { "name": "chatMute", "id": "1006325441046519848" }},
          { label: "Bot Düzenleme", description: "Botların isim, pp ve hakkımdasını değiştirebilirsiniz.", value: "botguncelle", emoji: { "name": "chatMute", "id": "1006325441046519848" }},
          { label: "Yedekleme", description: "Sunucunun anlık olarak tüm verilerini yedekler.", value: "yedekleoç", emoji: { "name": "chatMute", "id": "1006325441046519848" }},
          { label: "Rol & Seçenek Kur", description: "Rol alma ve seçenek'lerin kurulumunu yapabilirsiniz.", value: "seçenekkur", emoji: { "name": "chatMute", "id": "1006325441046519848" }},
          { label: "Log Kur", description: "Botun ihtiyacı olan log kanallarını kurar.", value: "logkur", emoji: { "name": "chatMute", "id": "1006325441046519848" }},
          { label: "Emojileri Kur", description: "Botun ihtiyacı olan emojileri kurar.", value: "emojikur", emoji: { "name": "chatMute", "id": "1006325441046519848" }},
          { label: "Ayarlar Listesi", description: "Yapılabilen ayarların listesini atar.", value: "ayarlistesi", emoji: { "name": "chatMute", "id": "1006325441046519848" }},
          { label: "Ayarlar", description: "Yapılan ayarları listeler.", value: "ayarlar", emoji: { "name": "chatMute", "id": "1006325441046519848" }},
          { label: "Rol Kurulum", description: "Rol alma menüsü için gerekli olan tüm rolleri kurar.", value: "seçenekrol", emoji: { "name": "chatMute", "id": "1006325441046519848" }},
          { label: "Yasaklı Tag", description: "Sunucunuz'a yasaklı tag ekleyebilir veya kaldırabilirsiniz.", value: "yasaktag", emoji: { "name": "chatMute", "id": "1006325441046519848" }},
...
\` ••❯ \` **${message.guild.name} Sunucusuna Ait Ayarlanabilir Özellikler** (\`${özellikler.length} adet bulunmaktadır.\`): ${özellikler.map(o => `${o.name}`).join(", ")}`, ephemeral: true}), message.react(message.guild.emojiGöster(emojiler.Onay)), x.delete().catch(err => {})
        ...
        .setPlaceholder("🎆 Ayarlar")
        .addOptions(
          { label: "Tüm Ayarları Görüntüle", description: "Sunucuda yapılan tüm ayarları gösterir.", value: "ayarlar_tum", emoji: { "name": "chatMute", "id": "1006325441046519848" }},
          { label: "Genel Sunucu Ayarları", description: "Genel sunucu ayarlarını gösterir.", value: "ayarlar_sunucu", emoji: { "name": "chatMute", "id": "1006325441046519848" }},
          { label: "Rol Ayarları", description: "Sunucuda ki rol ayarlarını gösterir.", value: "ayarlar_role", emoji: { "name": "chatMute", "id": "1006325441046519848" }},
          { label: "Kanal Ayarları", description: "Sunucuda ki kanal ayarlarını gösterir.", value: "ayarlar_channel", emoji: { "name": "chatMute", "id": "1006325441046519848" }},
          { label: "Cezalandırma Ayarları", description: "Sunucuda ki cezalandırma ayarlarını gösterir.", value: "ayarlar_punitives", emoji: { "name": "chatMute", "id": "1006325441046519848" }},
          { label: "Teyit Ayarları", description: "Sunucuda ki teyit ayarlarını gösterir.", value: "ayarlar_register", emoji: { "name": "chatMute", "id": "1006325441046519848" }},
          { label: "Limit Ayarları", description: "Sunucu da ki guard limit ayarlarını gösterir.", value: "ayarlar_limit", emoji: { "name": "chatMute", "id": "1006325441046519848" }},
          { label: "Diğer Ayarlar", description: "Diğer ayarları gösterir.", value: "ayarlar_stat", emoji: { "name": "chatMute", "id": "1006325441046519848" }},
