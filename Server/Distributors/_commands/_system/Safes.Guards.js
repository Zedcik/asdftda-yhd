...
module.exports = {
    Isim: "güvenlik",
    Komut: ["yarram", "guard-settings","guards","shelbyguard", "guard"],
    Kullanim: "",
    Aciklama: "",
    Kategori: "-",
    Extend: true,
...
.addField("Nasıl Eklenir?", `Örn: \`${sistem.botSettings.Prefixs[0]}guards <@shelby/@Rol/ID(Rol,Üye)> <${option.map(x => x).join(", ")}>\` komutu ile ekleyebilir/çıkartabilirsiniz.
