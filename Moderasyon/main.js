...
client.emojiler = {
  onay: "shelby_tik",
  iptal: "shelby_iptal",
  cevrimici: "shelby_online",
  rahatsizetmeyin: "shelby_dnd",
  bosta: "shelby_away",
  gorunmez: "shelby_offline",
  erkekEmoji: "shelby_man",
  kizEmoji: "shelby_woman",
  sagEmoji: "shelby_sag",
  tikEmoji: "shelby_tik",
  aktifEmoji: "shelby_acik",
  deaktifEmoji: "shelby_kapali",
  muteEmoji: "shelby_muted",
  unmuteEmoji: "shelby_unmuted",
  deafnedEmoji: "shelby_deafned",
  undeafnedEmoji: "shelby_undeafned"
};
...
client.on("message", async message => {
  ...
  if (komut.YetkiliROL === true && üye.user.username.includes(sunucuData.TAG)) {
      ...
      if (komut.YetkiliROL === true && üye.user.username.includes(sunucuData.TAG)) {
        ...
        üye.roles.add(komut.verilcekRol).then(a => message.channel.send(new MessageEmbed().setColor("RANDOM").setDescription(`${üye} üyesine ${komut.verilcekRol.map(x => `<@&${x}>`)} yetkileri verildi!`)))
