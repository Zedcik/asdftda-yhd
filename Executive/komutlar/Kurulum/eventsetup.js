...
`)
     ...
     let data = await eventayar.findOne({})
            if (["etkinlik", "Etkinlik"].some(y => y === sec)) {
                ...
                data.ETKINLIK = select.id, await data.save(), message.react(client.emojis.cache.find(res => res.name === "shelby_tik"));
            };
            
            if (["çekiliş","Çekiliş","Cekiliş"].some(y => y === sec)) {
                let select = message.mentions.roles.first();
                if (!select) return message.react(client.emojis.cache.find(res => res.name === "shelby_iptal"));
                data.CEKILIS = select.id, await data.save(), message.react(client.emojis.cache.find(res => res.name === "shelby_tik"));
            };

            if (["alone", "Alone"].some(y => y === sec)) {
                let select = message.mentions.roles.first();
                if (!select) return message.react(client.emojis.cache.find(res => res.name === "shelby_iptal"));
                data.ALONE = select.id, await data.save(), message.react(client.emojis.cache.find(res => res.name === "shelby_tik"));
            };
            if (["lovers", "Lovers"].some(y => y === sec)) {
                let select = message.mentions.roles.first();
                if (!select) return message.react(client.emojis.cache.find(res => res.name === "shelby_iptal"));
                data.LOVERS = select.id, await data.save(), message.react(client.emojis.cache.find(res => res.name === "shelby_tik"));
            };

            if (["balık","Balık","balik"].some(y => y === sec)) {
                let select = message.mentions.roles.first();
                if (!select) return message.react(client.emojis.cache.find(res => res.name === "shelby_iptal"));
                data.BALIK = select.id, await data.save(), message.react(client.emojis.cache.find(res => res.name === "shelby_tik"));
            };
            if (["kova","Kova"].some(y => y === sec)) {
                let select = message.mentions.roles.first();
                if (!select) return message.react(client.emojis.cache.find(res => res.name === "shelby_iptal"));
                data.KOVA = select.id, await data.save(), message.react(client.emojis.cache.find(res => res.name === "shelby_tik"));
            };
            if (["yay", "Yay"].some(y => y === sec)) {
                let select = message.mentions.roles.first();
                if (!select) return message.react(client.emojis.cache.find(res => res.name === "shelby_iptal"));
                data.YAY = select.id, await data.save(), message.react(client.emojis.cache.find(res => res.name === "shelby_tik"));
            };
            if (["akrep","Akrep"].some(y => y === sec)) {
                let select = message.mentions.roles.first();
                if (!select) return message.react(client.emojis.cache.find(res => res.name === "shelby_iptal"));
                data.AKREP = select.id, await data.save(), message.react(client.emojis.cache.find(res => res.name === "shelby_tik"));
            };
            if (["terazi","Terazi"].some(y => y === sec)) {
                let select = message.mentions.roles.first();
                if (!select) return message.react(client.emojis.cache.find(res => res.name === "shelby_iptal"));
                data.TERAZI = select.id, await data.save(), message.react(client.emojis.cache.find(res => res.name === "shelby_tik"));
            };
            if (["başak","Başak","basak"].some(y => y === sec)) {
                let select = message.mentions.roles.first();
                if (!select) return message.react(client.emojis.cache.find(res => res.name === "shelby_iptal"));
                data.BASAK = select.id, await data.save(), message.react(client.emojis.cache.find(res => res.name === "shelby_tik"));
            };
            if (["aslan","Aslan"].some(y => y === sec)) {
                let select = message.mentions.roles.first();
                if (!select) return message.react(client.emojis.cache.find(res => res.name === "shelby_iptal"));
                data.ASLAN = select.id, await data.save(), message.react(client.emojis.cache.find(res => res.name === "shelby_tik"));
            };
            if (["yengeç","Yengeç","yengec"].some(y => y === sec)) {
                let select = message.mentions.roles.first();
                if (!select) return message.react(client.emojis.cache.find(res => res.name === "shelby_iptal"));
                data.YENGEC = select.id, await data.save(), message.react(client.emojis.cache.find(res => res.name === "shelby_tik"));
            };
            if (["ikizler","İkizler"].some(y => y === sec)) {
                let select = message.mentions.roles.first();
                if (!select) return message.react(client.emojis.cache.find(res => res.name === "shelby_iptal"));
                data.IKIZLER = select.id, await data.save(), message.react(client.emojis.cache.find(res => res.name === "shelby_tik"));
            };
            if (["boğa","boga","Boğa"].some(y => y === sec)) {
                let select = message.mentions.roles.first();
                if (!select) return message.react(client.emojis.cache.find(res => res.name === "shelby_iptal"));
                data.BOGA = select.id, await data.save(), message.react(client.emojis.cache.find(res => res.name === "shelby_tik"));
            };
            if (["koç","Koç","koc"].some(y => y === sec)) {
                let select = message.mentions.roles.first();
                if (!select) return message.react(client.emojis.cache.find(res => res.name === "shelby_iptal"));
                data.KOC = select.id, await data.save(), message.react(client.emojis.cache.find(res => res.name === "shelby_tik"));
            };
