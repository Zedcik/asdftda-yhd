const {
  ...
  module.exports.run = async (client, message, args, durum, kanal) => {
    if (message.member.permissions.has(128) || durum) 

    if (!message.guild) return;
    let alt_yönetim = ["987805858656292899"];
    let orta_yönetim = ["987805858933133370","987805858954092597"]; 
    let üst_yönetim = ["987805858954092601","987805858954092602"]; 
