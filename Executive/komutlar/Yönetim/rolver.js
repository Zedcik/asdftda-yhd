...
module.exports.run = async (client, message, args, durum, kanal) => {
    ...
    await rollog.find({
        ...
        if (sunucuData.GKV.some(i => i == message.author.id) || message.author.id === message.guild.ownerID || message.member.permissions.has(8)||(message.member.permissions.has(128)) || durum) {
            let sec = args[0]
