          ...
          veri.forEach((user, index) => {
            setTimeout(async () => {
              ...
              if (user.gorev == "ses") {
                ...
                client.channels.cache.get("989274417068671007").send(`<@${user.user}> Bugün <#${MessageRandom}> kanalında [\` ${miktarlar} mesaj \`] yazman gerekiyor.`);
                ...
                if (user.gorev == "taglı") {
                client.channels.cache.get("989274417068671007").send(`<@${user.user}> Bugün [\` ${miktarlar} taglı \`] üye çekmen gerekiyor.`);
                ...
                if (user.gorev == "teyit") {
                client.channels.cache.get("989274417068671007").send(`<@${user.user}> Bugün [\` ${miktarlar} kayıt \`] yapman gerekiyor.`);
                ...
                if (user.gorev == "davet") {
                client.channels.cache.get("989274417068671007").send(`<@${user.user}> Bugün [\` ${miktarlar} davet \`] yapman gerekiyor.`);
