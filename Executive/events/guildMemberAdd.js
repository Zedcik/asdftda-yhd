...
module.exports = async member => {
  ...
  let underworldKontrol = await underworldInterval.findOne({
    userID: member.id
  }) || {
    jailed: false
  };
...
:tada: ${member.toString()}, **† Witcher** sunucumuza hoş geldin. 
...
Kayıt olduktan sonra <#${rules}> kanalını okuduğunuzu kabul edeceğiz ve içeride yapılacak cezalandırma işlemlerini bunu göz önünde bulundurarak yapacağız.`).catch(console.error);
    })
